...
namespace Rice_Agency.Controllers
{
    ...
    {
        Views.dbRiceAgencyEntities1 db = new Views.dbRiceAgencyEntities1();
        ...
        public void BuildEmailTemplate(int regID)
        {
            ...
            var url = "http://localhost:58135/" + "Register/Confirm?regId=" + regID;
        ...
        public static void BuildEmailTemplate(string subjectText, string bodyText, string sendTo)
        {
            ...
            from = "tonmoykabir2010@gmail.com";
            to = sendTo.Trim();
            bcc = "";
            cc = "";
            subject = subjectText;
        ...
        public static void SendEmail(MailMessage mail)
        {
            ...
            client.Credentials = new System.Net.NetworkCredential("tonmoykabir2010@gmail.com", "01717719240");
            try
            {
                client.Send(mail);
            }
