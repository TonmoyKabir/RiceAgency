...
-- --------------------------------------------------
-- Date Created: 04/09/2022 00:01:12
-- Generated from EDMX file: G:\Spring 2022\CSE470\Project\18301245_Tonmoy Kabir_Project\Rice Agency\Rice Agency\DAL\Model1.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK__Tbl_Cart__CartSt__267ABA7A]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_Cart] DROP CONSTRAINT [FK__Tbl_Cart__CartSt__267ABA7A];
GO
IF OBJECT_ID(N'[dbo].[FK__Tbl_Produ__Quant__145C0A3F]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_Product] DROP CONSTRAINT [FK__Tbl_Produ__Quant__145C0A3F];
GO
IF OBJECT_ID(N'[dbo].[FK__Tbl_Shipp__Membe__1CF15040]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_ShippingDetails] DROP CONSTRAINT [FK__Tbl_Shipp__Membe__1CF15040];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Tbl_Catergory]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Tbl_Catergory];
GO
...
-- Creating table 'Tbl_Catergory'
CREATE TABLE [dbo].[Tbl_Catergory] (
...
-- Creating primary key on [CategoryId] in table 'Tbl_Catergory'
ALTER TABLE [dbo].[Tbl_Catergory]
ADD CONSTRAINT [PK_Tbl_Catergory]
...
ALTER TABLE [dbo].[Tbl_Cart]
ADD CONSTRAINT [FK__Tbl_Cart__CartSt__267ABA7A]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Tbl_Cart__CartSt__267ABA7A'
CREATE INDEX [IX_FK__Tbl_Cart__CartSt__267ABA7A]
ON [dbo].[Tbl_Cart]
    ([ProductId]);
GO
...
ALTER TABLE [dbo].[Tbl_Product]
ADD CONSTRAINT [FK__Tbl_Produ__Quant__145C0A3F]
    FOREIGN KEY ([CategoryId])
    REFERENCES [dbo].[Tbl_Catergory]
        ([CategoryId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK__Tbl_Produ__Quant__145C0A3F'
CREATE INDEX [IX_FK__Tbl_Produ__Quant__145C0A3F]
ON [dbo].[Tbl_Product]
    ([CategoryId]);
GO
